...
Cleaning data by removing stopwords and lemmatization.
Using TfidfVectorizer to find the best features for analysis.
Using Sklean.naive_bayes.MultinomialNB() algorithm for predictions
# About Dataset :-
